...
const GIPHY_RANDOM_ENDPOINT = '/v1/gifs/random';
const RANDOM_KEYWORD_COMMAND = '/random';

module.exports = {
    // Giphy
    GIPHY_BASE_URL, GIPHY_API_KEY_SUFIX, GIPHY_SEARCH_ENDPOINT, GIPHY_RANDOM_ENDPOINT, RANDOM_KEYWORD_COMMAND,
